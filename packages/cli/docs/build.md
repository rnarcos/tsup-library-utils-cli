...
tsup-lib build --path ./packages/my-lib

# Build with verbose output
tsup-lib build --verbose
```
...
# Build single package in monorepo
cd packages/my-lib && tsup-lib build
```
...
tsup-lib build --skip-validation
