# @tsup-lib/eslint-config

ESLint configuration for tsup-library-utils-cli projects.

## Installation

```bash
npm install --save-dev @tsup-lib/eslint-config eslint
```
...
// .eslintrc.cjs
module.exports = {
  extends: ['@tsup-lib/eslint-config/base'],
};
```
...
// .eslintrc.cjs
module.exports = {
  extends: ['@tsup-lib/eslint-config/typescript'],
  parserOptions: {
...
// .eslintrc.cjs
module.exports = {
  extends: ['@tsup-lib/eslint-config/react'],
};
```
...
// .eslintrc.cjs
module.exports = {
  extends: ['@tsup-lib/eslint-config/typescript', '@tsup-lib/eslint-config/react'],
  parserOptions: {
    project: './tsconfig.json',
  },
};
